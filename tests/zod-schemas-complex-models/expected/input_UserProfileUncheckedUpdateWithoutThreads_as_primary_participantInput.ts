...
export interface UserProfileUncheckedUpdateWithoutThreads_as_primary_participantInput {
  profile_id: any;
...
export const UserProfileUncheckedUpdateWithoutThreads_as_primary_participantInputSchema = z.object({
  profile_id: z.string(),
