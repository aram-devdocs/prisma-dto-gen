...
export interface UserProfileUncheckedCreateWithoutUser_two_step_codesInput {
  profile_id: string;
...
export const UserProfileUncheckedCreateWithoutUser_two_step_codesInputSchema = z.object({
  profile_id: z.string(),
