...
export interface UserProfileUncheckedCreateWithoutThreads_as_primary_participantInput {
  profile_id: string;
...
export const UserProfileUncheckedCreateWithoutThreads_as_primary_participantInputSchema = z.object({
  profile_id: z.string(),
