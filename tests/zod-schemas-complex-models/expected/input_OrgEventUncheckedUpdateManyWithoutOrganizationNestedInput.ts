...
export interface OrgEventUncheckedUpdateManyWithoutOrganizationNestedInput {
  create?: any;
  connectOrCreate?: any;
  upsert?: any;
  createMany?: any;
...
export const OrgEventUncheckedUpdateManyWithoutOrganizationNestedInputSchema = z.object({
