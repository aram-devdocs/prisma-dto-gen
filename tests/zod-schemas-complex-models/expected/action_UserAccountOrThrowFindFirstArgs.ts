...
export interface UserAccountOrThrowFindFirstArgs {
  where?: {
  ...
  orderBy?:
    ...
    | any /* circular reference to UserAccountOrderByWithRelationInput */;
  cursor?: {
    account_id?: string;
    AND?: any /* circular reference to UserAccountWhereInput */;
    OR?: any /* circular reference to UserAccountWhereInput */;
...
export const UserAccountOrThrowFindFirstArgsSchema = z.object({
