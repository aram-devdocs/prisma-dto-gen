...
export interface UserProfileUncheckedCreateWithoutOrg_membershipsInput {
  profile_id?: string;
...
export const UserProfileUncheckedCreateWithoutOrg_membershipsInputSchema = z.object({
