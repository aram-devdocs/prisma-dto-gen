...
export interface UserProfileUncheckedUpdateWithoutThreads_as_secondary_participantInput {
  profile_id?: any;
...
export const UserProfileUncheckedUpdateWithoutThreads_as_secondary_participantInputSchema =
  z.object({
