...
export interface UserProfileUncheckedCreateWithoutThreads_as_secondary_participantInput {
  profile_id?: string;
...
export const UserProfileUncheckedCreateWithoutThreads_as_secondary_participantInputSchema =
  z.object({
