...
export interface UserProfileUncheckedCreateWithoutUser_notificationsInput {
  profile_id: string;
...
export const UserProfileUncheckedCreateWithoutUser_notificationsInputSchema = z.object({
  profile_id: z.string(),
