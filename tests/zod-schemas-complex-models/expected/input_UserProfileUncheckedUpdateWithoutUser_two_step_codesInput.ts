...
export interface UserProfileUncheckedUpdateWithoutUser_two_step_codesInput {
  profile_id: any;
...
export const UserProfileUncheckedUpdateWithoutUser_two_step_codesInputSchema = z.object({
  profile_id: z.string(),
