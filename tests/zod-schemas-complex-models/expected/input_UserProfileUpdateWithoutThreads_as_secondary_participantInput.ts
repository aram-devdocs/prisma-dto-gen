...
export interface UserProfileUpdateWithoutThreads_as_secondary_participantInput {
  profile_id: any;
...
export const UserProfileUpdateWithoutThreads_as_secondary_participantInputSchema = z.object({
  profile_id: z.string(),
