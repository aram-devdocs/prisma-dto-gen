...
export interface TwoStepVerificationOrThrowFindFirstArgs {
  where?: {
  ...
  orderBy?:
    ...
    | any /* circular reference to TwoStepVerificationOrderByWithRelationInput */;
  cursor?: {
...
export const TwoStepVerificationOrThrowFindFirstArgsSchema = z.object({
