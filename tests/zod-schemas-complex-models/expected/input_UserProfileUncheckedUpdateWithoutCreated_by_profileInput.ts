...
export interface UserProfileUncheckedUpdateWithoutCreated_by_profileInput {
  profile_id?: any;
...
export const UserProfileUncheckedUpdateWithoutCreated_by_profileInputSchema = z.object({
