...
export interface UserProfileUncheckedUpdateWithoutOrg_membershipsInput {
  profile_id?: any;
...
export const UserProfileUncheckedUpdateWithoutOrg_membershipsInputSchema = z.object({
