...
export interface UserProfileUncheckedCreateWithoutCreated_by_profileInput {
  profile_id: string;
...
export const UserProfileUncheckedCreateWithoutCreated_by_profileInputSchema = z.object({
  profile_id: z.string(),
