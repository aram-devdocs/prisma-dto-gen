...
export interface CreateManyTwoStepVerificationAndReturnOutputTypeOutput {
...
export const CreateManyTwoStepVerificationAndReturnOutputTypeOutputSchema = z.object({
