...
export interface PaymentOrThrowFindFirstArgs {
  where?: {
  ...
  orderBy?:
    ...
    | any /* circular reference to PaymentOrderByWithRelationInput */;
  cursor?: {
    payment_id?: string;
    AND?: any /* circular reference to PaymentWhereInput */;
    OR?: any /* circular reference to PaymentWhereInput */;
...
export const PaymentOrThrowFindFirstArgsSchema = z.object({
