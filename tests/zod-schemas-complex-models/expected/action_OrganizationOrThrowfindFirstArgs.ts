...
export interface OrganizationOrThrowFindFirstArgs {
  where?: {
  ...
  orderBy?:
    ...
    | any /* circular reference to OrganizationOrderByWithRelationInput */;
  cursor?: {
...
export const OrganizationOrThrowFindFirstArgsSchema = z.object({
