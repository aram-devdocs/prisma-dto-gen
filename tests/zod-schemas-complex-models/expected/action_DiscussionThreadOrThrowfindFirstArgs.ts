...
export interface DiscussionThreadOrThrowFindFirstArgs {
  where?: {
  ...
  orderBy?:
    ...
    | any /* circular reference to DiscussionThreadOrderByWithRelationInput */;
  cursor?: {
    thread_id?: string;
    AND?: any /* circular reference to DiscussionThreadWhereInput */;
    OR?: any /* circular reference to DiscussionThreadWhereInput */;
...
export const DiscussionThreadOrThrowFindFirstArgsSchema = z.object({
