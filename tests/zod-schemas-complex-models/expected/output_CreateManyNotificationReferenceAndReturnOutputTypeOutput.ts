...
export interface CreateManyNotificationReferenceAndReturnOutputTypeOutput {
...
export const CreateManyNotificationReferenceAndReturnOutputTypeOutputSchema = z.object({
