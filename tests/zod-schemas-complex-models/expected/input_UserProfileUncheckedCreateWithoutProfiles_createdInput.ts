...
export interface UserProfileUncheckedCreateWithoutProfiles_createdInput {
  profile_id: string;
...
export const UserProfileUncheckedCreateWithoutProfiles_createdInputSchema = z.object({
  profile_id: z.string(),
