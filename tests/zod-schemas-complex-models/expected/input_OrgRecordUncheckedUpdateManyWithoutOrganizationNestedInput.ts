...
export interface OrgRecordUncheckedUpdateManyWithoutOrganizationNestedInput {
  create?: any;
  connectOrCreate?: any;
  upsert?: any;
  createMany?: any;
...
export const OrgRecordUncheckedUpdateManyWithoutOrganizationNestedInputSchema = z.object({
