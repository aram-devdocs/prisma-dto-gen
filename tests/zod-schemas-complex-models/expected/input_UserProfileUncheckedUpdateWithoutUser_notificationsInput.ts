...
export interface UserProfileUncheckedUpdateWithoutUser_notificationsInput {
  profile_id?: any;
...
export const UserProfileUncheckedUpdateWithoutUser_notificationsInputSchema = z.object({
