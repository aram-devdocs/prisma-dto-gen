...
export interface UserProfileCreateWithoutThreads_as_secondary_participantInput {
  profile_id?: string;
...
export const UserProfileCreateWithoutThreads_as_secondary_participantInputSchema = z.object({
