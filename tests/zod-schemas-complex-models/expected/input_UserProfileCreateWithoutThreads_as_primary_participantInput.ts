...
export interface UserProfileCreateWithoutThreads_as_primary_participantInput {
  profile_id?: string;
...
export const UserProfileCreateWithoutThreads_as_primary_participantInputSchema = z.object({
