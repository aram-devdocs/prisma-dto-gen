...
export interface OrgMembershipOrThrowFindFirstArgs {
  where?: {
  ...
  orderBy?:
    | {
        ...
        user_profile?: {
          ...
          org_memberships?: any /* circular reference to OrgMembershipOrderByRelationAggregateInput */;
          payments?: {
            _count?: any;
          };
        };
      }[]
    | any /* circular reference to OrgMembershipOrderByWithRelationInput */;
  cursor?: {
...
export const OrgMembershipOrThrowFindFirstArgsSchema = z.object({
