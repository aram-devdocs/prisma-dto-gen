...
export interface UserNotificationOutput {
  ...
  notification_refs?: {
    ...
    notification: {
      ...
      read_timestamp?: Date | null;
      message: string;
      notification_refs: any /* circular reference to NotificationReference */[];
      user_profile: {
        profile_id: string;
...
export const UserNotificationOutputSchema = z.object({
      ...
      z.object({
        ...
        notification: z.object({
          ...
          notification_refs: z.array(
            z.any() /* circular reference to NotificationReferenceSchema */,
          ),
